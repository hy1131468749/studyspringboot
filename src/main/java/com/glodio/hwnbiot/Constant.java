...
public class Constant {
    ...
    public static final String BASE_URL = "https://112.93.129.154:8743";

    //please replace the appId and secret, when you use the demo.
    public static final String APPID = "0V6CCN_YadlUvxtT7E8PrkgSJ04a";
    public static final String SECRET = "EZHvUfoWzeTk219mJhdBoAk4tKoa";
     ...
     */
    public static final String CALLBACK_BASE_URL = "http://glodiotest.f3322.net:7080";
    ...
    public static String SELFCERTPATH = "/src/main/resources/secret/outgoing.CertwithKey.pkcs12";
    public static String TRUSTCAPATH = "/src/main/resources/secret/ca.jks";
